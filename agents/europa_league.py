...
prompt = f"""
Obiettivo: FAI UNA RICERCA SUL WEB e compila una lista di partite di UEFA Europa League in TV per OGGI ({date_str}) e fino alle 06:00 (CET) del giorno successivo.
...
try:
    ...
    print(f"Dati Europa League aggiornati! Eventi: {len(events)}")
