...
OUTPUT_FILE = "data/champions.json"
...
prompt = f"""
Obiettivo: FAI UNA RICERCA SUL WEB e compila una lista di partite di UEFA Champions League in TV per OGGI ({date_str}) e fino alle 06:00 (CET) del giorno successivo.
...
- Juventus, Inter, Milan, Napoli, Atalanta, Lazio, Roma, Fiorentina, Bologna, Monza, Catanzaro
...
try:
    ...
    print(f"Dati Champions League aggiornati! Eventi: {len(events)}")
